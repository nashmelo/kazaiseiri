  ...
  return (
    <div onClick={onClose} style={overlayStyle}>
      <div onClick={(e) => e.stopPropagation()} style={modalStyle}>
        ...
        <div style={bodyStyle}>
          {faqs.map((faq, index) => (
            <section key={faq.question} style={cardStyle}>
              <div style={cardHeadStyle}>
                <span style={iconStyle}>Q{index + 1}</span>
                <span style={cardTitleStyle}>{faq.question}</span>
              </div>

              <p style={cardTextStyle}>{faq.answer}</p>
            </section>
          ))}
        </div>
